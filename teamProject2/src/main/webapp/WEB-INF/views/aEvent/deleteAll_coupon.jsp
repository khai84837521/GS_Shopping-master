  	...
  	<%@include file="../inc/left.jsp"%>
        ...
        <div id="seller_content" class="item3">
            <div class="local_ov01 local_ov">
                ...
                <a href="${pageContext.request.contextPath}/aEvent/deleteAll_coupon" class="ov_listall">검색초기화</a>
            </div>
			
			<form name="flist" class="local_sch01 local_sch" action="${pageContext.request.contextPath}/aEvent/searchDel_couponList" method="post">
